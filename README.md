...
- Xbox 蓝牙手柄，用作主要人工遥控器。
- Yahboom ROS WiFi 摄像头模块，用于把图像通过 micro-ROS 发布到电脑。
...
- Yahboom ROS WiFi camera module for publishing images to the PC through micro-ROS.
