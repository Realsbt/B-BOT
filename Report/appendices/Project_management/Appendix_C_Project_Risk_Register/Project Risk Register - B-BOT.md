...
By the final report stage, the highest delivery risk had shifted from missing data to reproducibility and scope control. The E1-E11 datasets are now measured and the report separates the remaining limitations from claimed achievements. The main residual management control is to keep the submitted public GitHub commit frozen and consistent with the appendix evidence.
